...
struct st_mariadb_api {
  ...
  int (*mysql_send_query)(MYSQL *mysql, const char *q, size_t length);
  my_bool (*mysql_read_query_result)(MYSQL *mysql);
  int (*mysql_real_query)(MYSQL *mysql, const char *q, size_t length);
  ...
  CHARSET_INFO * (*mariadb_get_charset_by_name)(const char *csname);
  CHARSET_INFO * (*mariadb_get_charset_by_nr)(unsigned int csnr);
  size_t (*mariadb_convert_string)(const char *from, size_t *from_len, CHARSET_INFO *from_cs, char *to, size_t *to_len, CHARSET_INFO *to_cs, int *errorcode);
  ...
  unsigned long (*mysql_hex_string)(char *to, const char *from, size_t len);
  ...
  my_bool (*mysql_stmt_send_long_data)(MYSQL_STMT *stmt, unsigned int param_number, const char *data, size_t length);
