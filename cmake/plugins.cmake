...
FUNCTION(REGISTER_PLUGIN)
  ...
  if(NOT "${WITH_${cc_plugin}_PLUGIN}" STREQUAL "")
    SET(CC_PLUGIN_DEFAULT ${WITH_${cc_plugin}_PLUGIN})
  endif()
    ...
    if(${CC_PLUGIN_DEFAULT} STREQUAL "DYNAMIC")
      ...
      if(WIN32)
        ...
        configure_file(${CC_SOURCE_DIR}/win/resource.rc.in
                       ...
                       @ONLY)
        set(${sources} ${sources} ${CC_BINARY_DIR}/win/${target}.rc ${CC_SOURCE_DIR}/plugins/plugin.def)
      endif()
