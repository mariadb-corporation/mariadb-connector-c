...
const char *client_errors[]=
{
  ...
  "Keine Verbindung zu lokalem Server, socket: '%-.64s' (%d)",
  "Keine Verbindung zu Server auf %-.64s (%d)",
  "Kann TCP/IP-Socket nicht anlegen (%d)",
  "Unbekannter Server Host (%-.64s) (%d)",
  "Server nicht vorhanden",
  "Protokolle ungleich. Server Version = % d Client Version = %d",
  "Client got out of memory",
  "Wrong host info",
...
const char *client_errors[]=
{
  "Erro desconhecido do",
  "N�o pode criar 'UNIX socket' (%d)",
  "N�o pode se conectar ao servidor local atrav�s do 'socket' '%-.64s' (%d)",
  "N�o pode se conectar ao servidor em '%-.64s' (%d)",
  "N�o pode criar 'socket TCP/IP' (%d)",
  "'Host' servidor '%-.64s' (%d) desconhecido",
  "Servidor desapareceu",
  "Incompatibilidade de protocolos. Vers�o do Servidor: %d - Vers�o do Cliente: %d",
  "Cliente do com falta de mem�ria",
  "Informa��o inv�lida de 'host'",
  "Localhost via 'UNIX socket'",
  "%-.64s via 'TCP/IP'",
  "Erro na negocia��o de acesso ao servidor",
  "Conex�o perdida com servidor durante 'query'",
