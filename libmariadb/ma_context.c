...
int
my_context_spawn(struct my_context *c __attribute__((unused)), void (*f)(void *), void *d)
{
  return -1;
}
...
int
my_context_init(struct my_context *c __attribute__((unused)), size_t stack_size __attribute__((unused)))
{
  return -1;                                  /* Out of memory */
}
